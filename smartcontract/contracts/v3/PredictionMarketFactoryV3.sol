 ...
 */
contract PredictionMarketFactoryV3 is Ownable {
    ...
    function createPredictionMarket(
        ...
        uint256 minBetAmount = 1*10**18;
        PredictionMarketV3 newMarket = new PredictionMarketV3(tokenAddress, numberOfOptions, eventHash, expirationTime,msg.sender,oracleAddress, minBetAmount);
