...
const { betController, claimController, userBetInfoController, totalBetsInfoController, marketInfoController, resolveMarketController, withdrawBetController, getAdminController } = require('../controllers/market.controller');
